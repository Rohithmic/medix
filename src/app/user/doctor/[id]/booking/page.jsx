...
const MakePayment = () => {
  ...
  const PaymentSuccess = () => (
    <div className="flex flex-col items-center justify-center animate-fadeIn">
      ...
      <p className="mt-2 text-gray-600">Redirecting to appointments page...</p>
      <div className="mt-4 flex items-center justify-center">
        <div className="w-2 h-2 bg-blue-500 rounded-full animate-ping mr-1"></div>
        <div className="w-2 h-2 bg-blue-500 rounded-full animate-ping mr-1" style={{ animationDelay: "0.2s" }}></div>
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#e0e7ef] via-[#f3f4f6] to-[#e0e7ef] dark:from-[#232946] dark:via-[#334155] dark:to-[#232946] px-4 overflow-hidden">
          ...
          <defs>
            <linearGradient id="blob-blue-1" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#2563eb" stopOpacity="0.25">
                <animate attributeName="stopOpacity" values="0.25;0.15;0.25" dur="5s" repeatCount="indefinite" />
              </stop>
              <stop offset="100%" stopColor="#60a5fa" stopOpacity="0.15">
                <animate attributeName="stopOpacity" values="0.15;0.25;0.15" dur="5s" repeatCount="indefinite" />
              </stop>
            </linearGradient>
            <linearGradient id="blob-blue-2" x1="1" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#3b82f6" stopOpacity="0.2">
                <animate attributeName="stopOpacity" values="0.2;0.1;0.2" dur="7s" repeatCount="indefinite" />
              </stop>
              <stop offset="100%" stopColor="#93c5fd" stopOpacity="0.12">
                <animate attributeName="stopOpacity" values="0.12;0.22;0.12" dur="7s" repeatCount="indefinite" />
              </stop>
            </linearGradient>
            <linearGradient id="blob-blue-3" x1="0" y1="1" x2="1" y2="0">
              <stop offset="0%" stopColor="#1d4ed8" stopOpacity="0.15">
                <animate attributeName="stopOpacity" values="0.15;0.05;0.15" dur="8s" repeatCount="indefinite" />
              </stop>
              <stop offset="100%" stopColor="#7dd3fc" stopOpacity="0.1">
                <animate attributeName="stopOpacity" values="0.1;0.2;0.1" dur="8s" repeatCount="indefinite" />
              </stop>
            </linearGradient>
          </defs>
          <g>
            <path d="M400,400 Q470,320,540,400 T680,400 T820,400 T960,400 T1100,400" stroke="rgba(37, 99, 235, 0.2)" strokeWidth="2" fill="none">
            ...
            <ellipse cx="400" cy="400" rx="340" ry="220" fill="url(#blob-blue-1)">
              <animate attributeName="cx" values="400;420;380;400" dur="20s" repeatCount="indefinite" />
              <animate attributeName="cy" values="400;380;420;400" dur="18s" repeatCount="indefinite" />
            ...
            <ellipse cx="1100" cy="700" rx="260" ry="160" fill="url(#blob-blue-2)" opacity="0.7">
              <animate attributeName="cx" values="1100;1080;1120;1100" dur="19s" repeatCount="indefinite" />
              <animate attributeName="cy" values="700;720;680;700" dur="17s" repeatCount="indefinite" />
            ...
            <ellipse cx="700" cy="200" rx="180" ry="120" fill="url(#blob-blue-3)" opacity="0.5">
              <animate attributeName="cx" values="700;720;680;700" dur="22s" repeatCount="indefinite" />
              <animate attributeName="cy" values="200;180;220;200" dur="21s" repeatCount="indefinite" />
              <animate attributeName="rx" values="180;200;180" dur="12s" repeatCount="indefinite" />
              <animate attributeName="ry" values="120;140;120" dur="11s" repeatCount="indefinite" />
            </ellipse>
      ...
      <div className={`relative z-10 bg-white/30 backdrop-blur-lg shadow-2xl p-8 sm:p-10 rounded-3xl max-w-md w-full text-center border border-white/30 transition-all duration-700 transform ${
