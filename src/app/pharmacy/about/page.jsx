    ...
    <div className="min-h-screen bg-white dark:bg-[#181c2a] flex flex-col">
      ...
      <main className="flex-grow px-4  pb-10 md:pt-10 md:pb-16">
        <div className="max-w-5xl mx-auto bg-white/95 dark:bg-[#181c2a]/95 rounded-3xl shadow-2xl p-8 md:p-12 border-2 border-[#2563eb]/20 dark:border-[#60a5fa]/20">
          ...
          <h2 className="text-2xl font-bold text-[#2563eb] dark:text-[#60a5fa] mb-4 mt-8">Medix E-Pharmacy</h2>
          <p className="text-lg text-[#2563eb]/90 dark:text-[#60a5fa]/90 mb-8 leading-relaxed font-medium">
            Our integrated <strong>E-Pharmacy</strong> service allows patients to order medicines online with doorstep delivery. Users can browse medicines, add them to the cart, and proceed with a secure checkout process. With Medix E-Pharmacy, we ensure:
          </p>
          <ul className="list-disc list-inside text-[#2563eb]/80 dark:text-[#60a5fa]/80 mb-8 space-y-2">
          ...
          <p className="text-lg text-[#2563eb]/90 dark:text-[#60a5fa]/90 mb-8 leading-relaxed font-medium">
            Medix aims to be more than just a healthcare platform — we envision a connected healthcare network where technology bridges the gap between patients and quality healthcare, no matter where they are.
          </p>
          ...
          <div className="bg-[#2563eb]/10 dark:bg-[#60a5fa]/10 border-l-4 border-[#2563eb] dark:border-[#60a5fa] p-6 rounded-2xl">
            <p className="text-[#2563eb] dark:text-[#60a5fa] font-semibold text-lg">
              Together, we can build a healthier, safer, and more connected world.<br />– The Medix Team
            </p>
          </div>
        </div>
      </main>
